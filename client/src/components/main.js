  ...
  render(){
    return (
      <div>
        ...
        {/* <!-- 퀴즈 정답 입력 --> */}
        <div id="content_answer" class="container">
            {/* <!-- 퀴즈 내는 곳 --> */}
            ...
            {/* <p>퀴즈의 정답을 입력해주세요</p> */}
            <input class="submit_input" type="text" />
            <button id="quiz_button" class="submit_button">확인</button>
        </div>
        ...
        <div class="container">
            ...
            <br />
            <input class="submit_input" type="text" />
            <button id="mission_button" class="submit_button">확인</button>
        </div>
